...
The proof is in the plugins! [Over one thousand plugins](https://plugins.omarchy.org/) have been created in the week that [Quattro](https://github.com/omacom/omarchy/releases/tag/v4.0.0) has been out. That's an absolutely astounding testament to the technical flexibility of Quickshell, and how much agents love to write QML code.
