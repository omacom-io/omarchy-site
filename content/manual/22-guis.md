...
[Aether](https://github.com/bjarneo/aether) is a theming application that can extract colors from a background image and turn them into a complete, cohesive theme. It's the easiest way to [make your own theme](../making-your-own-theme/).
...
Omarchy's firewall is closed by default except for LocalSend's port, so this works out of the box on a fresh install. See [security](../security/).
