...
- **Display** carries a brightness slider, text size, monitor scaling presets, and — when you have more than one screen — per-monitor controls. See [monitors](../monitors/) for the deeper story.
...
The same things have commands, which is what you want for a [dotfiles](../dotfiles/) setup:
