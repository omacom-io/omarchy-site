...
In a simple test, we were able to achieve 36% performance gains on a 2019 MacBook Pro just by installing Omarchy.
 ...
 ![macbook-omarchy](/manual/images/macbook-omarchy.webp)
...
For the sake of this part, we'll assume you've already reviewed [Getting Started](../getting-started/) and have your USB drive ready. If you don't go ahead and do that now.
...
4. Proceed with the [install as normal](../getting-started/)
